...
{
    public delegate void UnityActionEx<T0>(T0 arg0);

    [Serializable]
    public class UnityEventEx<T0> : UnityEventBaseEx
    {
        public UnityEventEx() { }

        public void AddListener(UnityActionEx<T0> call)
        {
            AddCall(GetDelegate(call));
        }

        public void RemoveListener(UnityActionEx<T0> call)
        {
        ...
        private static BaseInvokableCall GetDelegate(UnityActionEx<T0> action)
        {
        ...
        internal void AddPersistentListener(UnityActionEx<T0> call)
        {
            AddPersistentListener(call, UnityEventCallState.RuntimeOnly);
        }

        internal void AddPersistentListener(UnityActionEx<T0> call, UnityEventCallState callState)
        {
        ...
        internal void RegisterPersistentListener(int index, UnityActionEx<T0> call)
        {
            if (call == null)
            {
