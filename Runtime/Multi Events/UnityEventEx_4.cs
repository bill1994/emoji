...
{
    public delegate void UnityActionEx<T0, T1, T2, T3>(T0 arg0, T1 arg1, T2 arg2, T3 arg3);

    [Serializable]
    public class UnityEventEx<T0, T1, T2, T3> : UnityEventBaseEx
    {
        public UnityEventEx() { }

        public void AddListener(UnityActionEx<T0, T1, T2, T3> call)
        {
            AddCall(GetDelegate(call));
        }

        public void RemoveListener(UnityActionEx<T0, T1, T2, T3> call)
        {
        ...
        private static BaseInvokableCall GetDelegate(UnityActionEx<T0, T1, T2, T3> action)
        {
        ...
        internal void AddPersistentListener(UnityActionEx<T0, T1, T2, T3> call)
        {
            AddPersistentListener(call, UnityEventCallState.RuntimeOnly);
        }

        internal void AddPersistentListener(UnityActionEx<T0, T1, T2, T3> call, UnityEventCallState callState)
        {
        ...
        internal void RegisterPersistentListener(int index, UnityActionEx<T0, T1, T2, T3> call)
        {
            if (call == null)
            {
