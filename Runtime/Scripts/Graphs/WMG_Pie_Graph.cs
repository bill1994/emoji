...
namespace Kyub.GraphMaker
{
	...
	public class WMG_Pie_Graph : WMG_Graph_Manager
	{
		...
		{
			get { return _autoCenterMinPadding; }
			set
			{
		...
		{
			get { return _swapColorsDuringSort; }
			set
			{
		...
		{
			get { return _explodeSymmetrical; }
			set
			{
		...
		{
			get { return _doughnutPercentage; }
			set
			{
		...
		{
			get { return _includeOthersLabel; }
			set
			{
		...
		{
			get { return _includeOthersColor; }
			set
			{
		...
		{
			get { return _sortAnimationDuration; }
			set
			{
		...
		{
			get { return _sliceLabelExplodeLength; }
			set
			{
		...
		{
			get { return _sliceLabelFontSize; }
			set
			{
		...
		{
			get { return _numberDecimalsInPercents; }
			set
			{
		...
		{
			get { return _hideZeroValueLegendEntry; }
			set
			{
		...
		{
			get { return _interactivityEnabled; }
			set
			{
		...
		{
			changeSpriteColor(background, color);
		}

		public void setBackgroundCircleColor(Color color)
		{
			changeSpriteColor(backgroundCircle, color);
		}
	}
}
