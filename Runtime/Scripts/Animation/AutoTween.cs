...
namespace MaterialUI
{
    ...
    {
        /// <summary>
        /// Max Smoothed DeltaTime to prevent huge spike in FPS
        /// </summary>
        //const float MAX_SMOOTH_DELTA_TIME = 0.03f;
        ...
        public virtual void UpdateTween()
        {
            ...
            {
                //Calculate Smooth DeltaTime
                //float currentTime = (m_ScaledTime ? Time.time : Time.unscaledTime) - m_StartTime;
                // m_DeltaTime = currentTime - m_DeltaTime <= MAX_SMOOTH_DELTA_TIME ? currentTime : (m_DeltaTime + MAX_SMOOTH_DELTA_TIME);
