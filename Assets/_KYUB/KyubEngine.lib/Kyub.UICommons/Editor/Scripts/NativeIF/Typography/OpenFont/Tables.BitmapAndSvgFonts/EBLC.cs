...
using System;
using System.IO;
using KyubEditor.Typography.OpenFont.Tables.BitmapFonts;
...
namespace KyubEditor.Typography.OpenFont.Tables
{
    ...
    class EBLC : TableEntry
    {
        ...
        //The 'EBLC' table uses the same format as the Apple Apple Advanced KyubEditor.Typography (AAT) 'bloc' table.
