// Based in Sourced from - https://github.com/Dover8/Unity-UI-Extensions/tree/range-slider
...
namespace KyubEditor.UI
{
    ...
    public class RangeSliderEditor : SelectableEditor
    {
        ...
        SerializedProperty m_OnLowValueChanged;
        SerializedProperty m_OnHighValueChanged;
        ...
        protected override void OnEnable()
        {
            ...
            m_OnLowValueChanged = serializedObject.FindProperty("m_OnLowValueChanged");
            m_OnHighValueChanged = serializedObject.FindProperty("m_OnHighValueChanged");
        }
        ...
        public override void OnInspectorGUI()
        {
            ...
            if (m_LowHandleRect.objectReferenceValue != null && m_HighHandleRect.objectReferenceValue != null)
            {
                ...
                EditorGUILayout.PropertyField(m_OnLowValueChanged);
                EditorGUILayout.PropertyField(m_OnHighValueChanged);
            }
            else
            {
