...
namespace Kyub.UI
{
    [AddComponentMenu("UI Commons/Range Slider", 34)]
    [ExecuteInEditMode]
    ...
    public class RangeSlider : Selectable, IDragHandler, IInitializePotentialDragHandler, ICanvasElement
    {
        ...
        private InteractionStateEnum _interactionState = InteractionStateEnum.None;
        ...
        public InteractionStateEnum currentInteractionState { get { return _interactionState; } }
        ...
        public override void OnPointerDown(PointerEventData eventData)
        {
            ...
            else
            {
                ...
                _interactionState = InteractionStateEnum.Bar;
                if (transition == Transition.ColorTint)
                {
        ...
        public override void OnPointerUp(PointerEventData eventData)
        {
            ...
            _interactionState = InteractionStateEnum.None;
        }
        ...
        private void UpdateDrag(PointerEventData eventData, Camera cam)
        {
            ...
            switch (_interactionState)
            {
                ...
                case InteractionStateEnum.Bar:
                    ...
                    break;
                case InteractionStateEnum.None:
                    break;
            }
        }
