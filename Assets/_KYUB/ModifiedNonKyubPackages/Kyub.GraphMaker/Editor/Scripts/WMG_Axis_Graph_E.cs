...
namespace Kyub.GraphMaker
{
	...
	public class WMG_Axis_Graph_E : WMG_E_Util
	{
		...
		void DrawYAxis()
		{
			...
			ExposeProperty(yAxisfields["AutoGrowShrinkType"]);
			...
			ExposeProperty(yAxisfields["OppositeSideTicks"]);
...
#if TMP_PRESENT
			graph.yAxis.AxisLabelFont = (TMP_FontAsset)EditorGUILayout.ObjectField("Axis Label Font", graph.yAxis.AxisLabelFont, typeof(TMP_FontAsset), false);
#else
		graph.yAxis.AxisLabelFont = (Font)EditorGUILayout.ObjectField ("Axis Label Font", graph.yAxis.AxisLabelFont, typeof(Font), false);
			...
			ExposeProperty(yAxisfields["AxisBoundedLabels"]);
			ExposeProperty(yAxisfields["OppositeSideLabels"]);
		...
		void DrawYAxis2()
		{
			...
			ExposeProperty(yAxis2fields["AutoGrowShrinkType"]);
			...
			ExposeProperty(yAxis2fields["OppositeSideTicks"]);
...
#if TMP_PRESENT
			graph.yAxis2.AxisLabelFont = (TMP_FontAsset)EditorGUILayout.ObjectField("Axis Label Font", graph.yAxis2.AxisLabelFont, typeof(TMP_FontAsset), false);
#else
		graph.yAxis2.AxisLabelFont = (Font)EditorGUILayout.ObjectField ("Axis Label Font", graph.yAxis2.AxisLabelFont, typeof(Font), false);
			...
			ExposeProperty(yAxis2fields["AxisBoundedLabels"]);
			ExposeProperty(yAxis2fields["OppositeSideLabels"]);
		...
		void DrawXAxis()
		{
			...
			ExposeProperty(xAxisfields["AutoGrowShrinkType"]);
			...
			ExposeProperty(xAxisfields["OppositeSideTicks"]);
...
#if TMP_PRESENT
			graph.xAxis.AxisLabelFont = (TMP_FontAsset)EditorGUILayout.ObjectField("Axis Label Font", graph.xAxis.AxisLabelFont, typeof(TMP_FontAsset), false);
#else
		graph.xAxis.AxisLabelFont = (Font)EditorGUILayout.ObjectField ("Axis Label Font", graph.xAxis.AxisLabelFont, typeof(Font), false);
			...
			ExposeProperty(xAxisfields["AxisBoundedLabels"]);
			ExposeProperty(xAxisfields["OppositeSideLabels"]);
