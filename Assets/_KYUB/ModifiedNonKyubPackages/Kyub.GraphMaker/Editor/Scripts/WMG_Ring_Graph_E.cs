...
#if TMP_PRESENT
			graph.labelsFont = (TMP_FontAsset)EditorGUILayout.ObjectField("Label Font", graph.labelsFont, typeof(TMP_FontAsset), false);
#else
...
#if TMP_PRESENT
			graph.dataLabelsFont = (TMP_FontAsset)EditorGUILayout.ObjectField("Data Label Font", graph.dataLabelsFont, typeof(TMP_FontAsset), false);
#else
