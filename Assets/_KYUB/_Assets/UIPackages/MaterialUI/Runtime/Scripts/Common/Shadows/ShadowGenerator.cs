    ...
    public class ShadowGenerator : MonoBehaviour
    {
        ...
        public void GenerateShadowFromImage()
        {
            ...
            if (sourceSprite != null)
            {
                ...
                {
                    sourceTex = ((DownloadHandlerTexture)www.downloadHandler).texture;
                    if(sourceTex != null)
                        sourceTex.hideFlags = HideFlags.HideAndDontSave;
                    //new Texture2D(sourceOriginalTexture.width, sourceOriginalTexture.height);
                    //sourceTex.hideFlags = HideFlags.HideAndDontSave;
