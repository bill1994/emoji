...
namespace Kyub.LocalNotification
{
    ...
    /// </remarks>
    public struct CrossLocalNotificationChannel
    {
        /// <summary>
        ...
        /// <summary>
        /// Initialize a new instance of <see cref="CrossLocalNotificationChannel"/> with
        /// optional fields set to their default values.
        /// </summary>
        public CrossLocalNotificationChannel(string id, string name, string description) : this()
        {
            Id = id;
            Name = name;
        ...
        /// <summary>
        /// Initialize a new instance of <see cref="CrossLocalNotificationChannel"/>, providing the notification style
        /// and optionally all other settings.
        /// </summary>
        public CrossLocalNotificationChannel(string id, string name, string description, NotificationStyle style, bool showsBadge = true, bool showLights = false, bool vibrates = true, bool highPriority = false, PrivacyMode privacy = PrivacyMode.Public, long[] vibrationPattern = null)
        {
            Id = id;
            Name = name;
            Description = description;
