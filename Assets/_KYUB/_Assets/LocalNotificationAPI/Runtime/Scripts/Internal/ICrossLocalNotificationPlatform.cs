...
namespace Kyub.LocalNotification
{
    ...
    /// </summary>
    public interface ICrossLocalNotificationsPlatform
    {
        /// <summary>
        /// Fired when a notification is received.
        /// </summary>
        event Action<ICrossLocalNotification> NotificationReceived;

        /// <summary>
        /// Create a new instance of a <see cref="ICrossLocalNotification"/> for this platform.
        /// </summary>
        /// <returns>A new platform-appropriate notification object.</returns>
        ICrossLocalNotification CreateNotification();
        ...
        void ScheduleNotification(ICrossLocalNotification gameNotification);
        ...
        /// </returns>
        ICrossLocalNotification GetLastNotification();
    ...
    public interface ICrossLocalNotificationsPlatform<TNotificationType> : ICrossLocalNotificationsPlatform
        where TNotificationType : ICrossLocalNotification
    {
        /// <summary>
