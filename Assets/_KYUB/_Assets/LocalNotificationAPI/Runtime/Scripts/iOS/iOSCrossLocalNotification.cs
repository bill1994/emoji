...
{
    /// <summary>
    /// iOS implementation of <see cref="ICrossLocalNotification"/>.
    /// </summary>
    public class iOSCrossLocalNotification : ICrossLocalNotification
    {
        ...
        /// </summary>
        public iOSCrossLocalNotification()
        {
        ...
        /// <summary>
        /// Instantiate a new instance of <see cref="iOSCrossLocalNotification"/> from a delivered notification.
        /// </summary>
        /// <param name="internalNotification">The delivered notification.</param>
        internal iOSCrossLocalNotification(iOSNotification internalNotification)
        {
