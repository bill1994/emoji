...
{
    /// <summary>
    /// Android specific implementation of <see cref="ICrossLocalNotification"/>.
    /// </summary>
    public class AndroidCrossLocalNotification : ICrossLocalNotification
    {
        ...
        /// <summary>
        /// Instantiate a new instance of <see cref="AndroidCrossLocalNotification"/>.
        /// </summary>
        public AndroidCrossLocalNotification()
        {
            internalNotification = new AndroidNotification();
        }

        /// <summary>
        /// Instantiate a new instance of <see cref="AndroidCrossLocalNotification"/> from a delivered notification
        /// </summary>
        ...
        internal AndroidCrossLocalNotification(AndroidNotification deliveredNotification, int deliveredId,
