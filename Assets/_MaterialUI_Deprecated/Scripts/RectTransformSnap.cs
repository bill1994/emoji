...
namespace MaterialUI
{
    ...
    [System.Obsolete("Useless Component")]
    public class RectTransformSnap : MonoBehaviour, ILayoutElement, ILayoutSelfController
    {
        ...
        /// </summary>
        [SerializeField]
        private RectTransform m_SourceRectTransform = null;
        /// <summary>
        ...
        /// </summary>
        [SerializeField]
        private bool m_ValuesArePercentage = false;
        /// <summary>
        /// If true, offset and padding are a percentage of the source values, rather than an additive.
        /// </summary>
        ...
        /// </summary>
        [SerializeField]
        private Vector2 m_OffsetPercent = Vector2.zero;
        /// <summary>
        /// The offset percent to multiply with the source position to apply to the rectTransform.
        /// </summary>
