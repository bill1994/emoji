...
namespace MaterialUI
{
    ...
    /// </summary>
    [ExecuteInEditMode]
    [System.Obsolete("Use MaterialCanvasScaler instead")]
    ...
    public class MaterialUIScaler : UIBehaviour
    {
        ...
        /// </summary>
        [SerializeField]
        private MaterialUIScaler m_TargetScaler = null;
        /// <summary>
        /// The scaler to use when set to 'copy other scaler' mode.
        /// <para></para>
        /// Scaling is recalculated when this value is changed.
        ...
        /// </summary>
        [SerializeField]
        private CanvasScaler m_TargetCanvasScaler = null;
        ...
        /// </summary>
        [SerializeField]
        private MaterialCanvasScaler.CanvasAreaChangedEvent m_OnCanvasAreaChanged = new MaterialCanvasScaler.CanvasAreaChangedEvent();
        /// <summary>
        /// Called when the scaleFactor or orientation are changed.
        /// <para></para>
        /// bool1 = Was the scaleFactor changed?
        ...
        /// bool2 = Was the orientation changed?
        /// </summary>
        public MaterialCanvasScaler.CanvasAreaChangedEvent onCanvasAreaChanged
        {
        ...
        protected override void Awake()
        {
            ...
            Debug.LogWarning("MaterialUIScaler is obsolete. Remove it from GameObject '" + gameObject.name +"' and use MaterialCanvasScaler instead");
        }
