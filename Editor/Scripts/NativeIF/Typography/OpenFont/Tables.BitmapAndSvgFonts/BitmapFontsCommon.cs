...
namespace KyubEditor.Typography.OpenFont.Tables.BitmapFonts
{
    ...
    class GlyphBitmapDataFmt1 : GlyphBitmapDataFormatBase
    {
        ...
        public SmallGlyphMetrics smallGlyphMetrics = default(SmallGlyphMetrics);
    ...
    class GlyphBitmapDataFmt6 : GlyphBitmapDataFormatBase
    {
        ...
        public BigGlyphMetrics bigMetrics = default(BigGlyphMetrics);
    ...
    class GlyphBitmapDataFmt8 : GlyphBitmapDataFormatBase
    {
        ...
        public SmallGlyphMetrics smallMetrics = default(SmallGlyphMetrics);
        public byte pad = 0;
        public EbdtComponent[] components = null;
        //Format 8: small metrics, component data
        //Type              Name            Description
