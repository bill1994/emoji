...
using KyubEditor.Typography.OpenFont.Tables;

namespace KyubEditor.Typography.OpenFont.Extensions
{
    ...
    public static partial class TypefaceExtensions
    {
        ...
        static int CalculateBTBD_Mac(Typeface typeface)
        {
            ...
            //The Macintosh metrics below are returned by the Apple Advanced KyubEditor.Typography(AAT) GetFontInfo() API.
            //
            //
        ...
        class CffBoundFinder : IGlyphTranslator
        {
            ...
            /// <summary>
            /// curve flatten steps  => this a copy from KyubEditor.Typography.Contours's GlyphPartFlattener
            /// </summary>
            int _nsteps = 3;
            ...
            public void Curve3(float x1, float y1, float x2, float y2)
            {
                ...
                //this a copy from KyubEditor.Typography.Contours -> GlyphPartFlattener
...
namespace KyubEditor.Typography.OpenFont.Tables
{
    /// <summary>
...
namespace KyubEditor.Typography.OpenFont
{
